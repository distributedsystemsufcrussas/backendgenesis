...
from app.api.db.base import ProductCreate,ProductCreateSuccessResponse,ListProductsSuccessResponse
...
@router_products.post("/", response_model=ProductCreateSuccessResponse, status_code=201)
...
@router_products.get("/", response_model=ListProductsSuccessResponse,status_code=201)
